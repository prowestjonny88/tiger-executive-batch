        ...
        case_results.append(
            {
                ...
                "perception": {
                    ...
                    "extraction": {
                        ...
                        "mcb_current_amp": extraction.mcb_current_amp,
                        "rccb_current_amp": extraction.rccb_current_amp,
                        "mcb_poles": extraction.mcb_poles,
                        "rccb_poles": extraction.rccb_poles,
                        "mcb_brand_model": extraction.mcb_brand_model,
                        "rccb_brand_model": extraction.rccb_brand_model,
                        "rccb_type": extraction.rccb_type,
                        "rccb_type_evidence": extraction.rccb_type_evidence,
                        "rccb_symbol_description": extraction.rccb_symbol_description,
                        "charger_brand_source": extraction.charger_brand_source,
                        "evdb_spec_status": extraction.evdb_spec_status,
